...
object ByteOperatorTests : ShouldSpec({
    withData(
        mapOf(
            "compareTo" to OperatorTest(
                source = """
                fun evalTest(a: Byte, b: Byte): Int = a.compareTo(b)
            ...
            "plus(Byte)" to OperatorTest(
                source = """
                fun evalTest(a: Byte, b: Byte): Int = a + b
            ...
            "plus(Long)" to OperatorTest(
                source = """
                fun evalTest(a: Byte, b: Long): Long = a + b
            ...
            "plus(Double)" to OperatorTest(
                source = """
                fun evalTest(a: Byte, b: Double): Double = a + b
            ...
            "rem(Byte)" to OperatorTest(
                source = """
                fun evalTest(a: Byte, b: Byte): Int = a.rem(b)
            ...
            "rem(Long)" to OperatorTest(
                source = """
                fun evalTest(a: Byte, b: Long): Long = a.rem(b)
            ...
            "rem(Double)" to OperatorTest(
                source = """
                fun evalTest(a: Byte, b: Double): Double = a.rem(b)
            ...
            "inc" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Byte = a.inc()
            ...
            "dec" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Byte = a.dec()
            ...
            "toByte" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Byte = a.toByte()
            ...
            "toShort" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Short = a.toShort()
            ...
            "toInt" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Int = a.toInt()
            ...
            "toLong" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Long = a.toLong()
            ...
            "toUByte" to OperatorTest(
                source = """
                fun evalTest(a: Byte): UByte = a.toUByte()
            ...
            "toUShort" to OperatorTest(
                source = """
                fun evalTest(a: Byte): UShort = a.toUShort()
            ...
            "toUInt" to OperatorTest(
                source = """
                fun evalTest(a: Byte): UInt = a.toUInt()
            ...
            "toULong" to OperatorTest(
                source = """
                fun evalTest(a: Byte): ULong = a.toULong()
            ...
            "toFloat" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Float = a.toFloat()
            ...
            "toDouble" to OperatorTest(
                source = """
                fun evalTest(a: Byte): Double = a.toDouble()
